(function (global, factory) {
	...
	(factory((global.ngxPapaparse = {}),global.ng.common,global.ng.core));
...
var PapaParseService = (function () {
    function PapaParseService(config) {
        this.config = config;
     ...
     * @return {?}
     */
    PapaParseService.prototype.parse = /**
     * Parse CSV to an array
     * @param {?} csv
     * @param {?=} config
     * @return {?}
     ...
     * @return {?}
     */
    PapaParseService.prototype.unparse = /**
     * Convert an array into CSV
     * @param {?} data
     * @param {?=} config
     * @return {?}
     ...
     * @return {?}
     */
    PapaParseService.prototype.setLocalChunkSize = /**
     * Set the size in bytes of each file chunk.
     * Used when streaming files obtained from the DOM that
     * exist on the local computer. Default 10 MB.
     * @param {?} value
     ...
     * @return {?}
     */
    PapaParseService.prototype.setRemoteChunkSize = /**
     * Set the size in bytes of each remote file chunk.
     * Used when streaming remote files. Default 5 MB.
     * @param {?} value
     * @return {?}
     ...
     * @return {?}
     */
    PapaParseService.prototype.setDefaultDelimiter = /**
     * Set the delimiter used when it is left unspecified and cannot be detected automatically. Default is comma.
     * @param {?} value
     * @return {?}
     */
...
var PapaParseModule = (function () {
    ...
    /** @nocollapse */
    PapaParseModule.ctorParameters = function () { return []; };
